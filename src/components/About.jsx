        ...
        <div className='about-wrapper'>
            <div className='about-summary'>
                        <div className="about-summary-left">
                            ...
                            <p>
                                Holder of an FE certificate and a Bachelor's Degree in Mechanical Engineering, currently pursuing a Master's in Computer Science. 
                            </p>
                            <p>    
                                Enthusiastic about AI, machine learning, and 
                                data science, eager to contribute and thrive in roles at the intersection of technology and innovation. Committed to leveraging my 
                                diverse engineering background to excel and make impactful contributions in any industry.
                            </p>
                        </div>
                    </div>
            <div className = "about-container">
                ...
                <section class= "intro">
                        ...
                        {/* <h1 className="header intro-header">About Me</h1> */}
 
                            {/* <div className='intro-summary'>
                                <p>
                                Passionate engineer with a strong drive for continuous learning and a curious mindset. Holder of an FE certificate and a Bachelor's 
                                Degree in Mechanical Engineering, currently pursuing a Master's in Computer Science. Enthusiastic about AI, machine learning, and 
                                data science, eager to contribute and thrive in roles at the intersection of technology and innovation. Committed to leveraging my 
                                diverse engineering background to excel and make impactful contributions in any industry.
                                </p> */}
                        {/* </div> */} 
